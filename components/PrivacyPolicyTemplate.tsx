...
const PrivacyPolicy = () => {
  return (
    <div className='flex flex-col'>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to STRMLIND.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to STRMLIND, accessible from <a href="http://www.strmlind.com" rel="external nofollow noopener" target="_blank">http://www.strmlind.com</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: inquire@strmlind.com</li>
        </ul>
    </div>
  )
}
