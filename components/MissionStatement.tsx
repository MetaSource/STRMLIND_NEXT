...
const MissionStatement = () => {
  return (<div id="mission-section" className='flex-center p-4 md:p-24 items-center w-full  bg-[#253551] text-center'>
            <p className='pt-24 pb-20 xl:text-[56px] sm:text-[36px] text-[34px] text-white font-light'>Our mission at STRMLIND is to modernize your
                ...
                against modern standards to give your
                business a competive edge in today's rapidly
                evolving world.
            </p>
        </div>
